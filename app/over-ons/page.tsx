    ...
    <PageLayout>
      ...
      <section style={{ background: "#0B0F0C", padding: "80px 0", position: "relative", overflow: "hidden" }}>
        ...
        <div className="site-wrap" style={{ position: "relative", zIndex: 1 }}>
          ...
          {/* Quote blok */}
          <div style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: "16px", padding: "14px 52px", display: "flex", alignItems: "center", gap: "32px" }}>
