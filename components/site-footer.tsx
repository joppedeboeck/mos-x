  ...
  return (
    <footer style={{ background: "#111111", borderTop: "1px solid #222222" }}>
      ...
      >
          ...
          <div className="lg:col-span-1 flex flex-col" style={{ gap: "0" }}>
            ...
            <div style={{ display: "flex", gap: "14px" }}>
              <a
                ...
                style={{ color: "#9BCB6C", transition: "color 150ms ease" }}
              ...
              <a
                href="https://www.facebook.com/profile.php?id=61551512872835"
                target="_blank" rel="noopener noreferrer"
                aria-label="Facebook"
                style={{ color: "#9BCB6C", transition: "color 150ms ease" }}
                onMouseEnter={e => (e.currentTarget.style.color = "#FFFFFF")}
              ...
              <a
                href="https://www.linkedin.com/in/yannick-gysen-3b0018247/"
                target="_blank" rel="noopener noreferrer"
                aria-label="LinkedIn"
                style={{ color: "#9BCB6C", transition: "color 150ms ease" }}
                onMouseEnter={e => (e.currentTarget.style.color = "#FFFFFF")}
        ...
        {/* Separator */}
        <div style={{ borderTop: "1px solid #222222", marginTop: "48px" }} />
      </div>
      ...
      >
        <div
          ...
          style={{ fontSize: "12px", color: "#666666", fontFamily: "var(--font-inter), system-ui, sans-serif" }}
        >
          ...
          <span className="flex gap-4">
            {(["Privacybeleid", "Algemene voorwaarden"] as const).map(l => (
              <Link
                key={l}
                href="#"
                style={{ color: "#666666", textDecoration: "none", transition: "color 150ms ease" }}
                onMouseEnter={e => (e.currentTarget.style.color = "#9BCB6C")}
