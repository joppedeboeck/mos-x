    ...
    <footer style={{ background: "#111111", borderTop: "1px solid #222222" }}>
          ...
          <div className="lg:col-span-1 flex flex-col" style={{ gap: "0" }}>
            ...
            <div style={{ display: "flex", gap: "14px" }}>
              <a
                ...
                style={{ color: "#888888", transition: "color 150ms ease" }}
                onMouseEnter={e => (e.currentTarget.style.color = "#5A9E2F")}
      ...
      >
        <div
          ...
          style={{ fontSize: "12px", color: "#777777", fontFamily: "var(--font-inter), system-ui, sans-serif" }}
        >
          ...
          <span className="flex gap-4">
            {(["Privacybeleid", "Algemene voorwaarden"] as const).map(l => (
              <Link
                key={l}
                href="#"
                style={{ color: "#777777", textDecoration: "none", transition: "color 150ms ease" }}
                onMouseEnter={e => (e.currentTarget.style.color = "#5A9E2F")}
