...
function ServiceCard({ s }: { s: typeof services[0] }) {
  ...
  return (
    ...
    >
      {/* Media area */}
      <div className="relative overflow-hidden" style={{ height: "420px", borderRadius: "12px 12px 0 0" }}>
        <img
          src={s.img}
          alt={s.title}
      ...
      <div className="site-wrap">
        ...
        <div className="max-w-2xl mb-14">
          ...
          <h2 className="font-bold leading-tight mb-3"
            style={{ fontFamily: "var(--font-montserrat), system-ui, sans-serif", fontSize: "clamp(1.75rem, 3.5vw, 2.75rem)", letterSpacing: "-0.02em", color: "#1A1A1A" }}>
            Alles voor een gezond dak.
          </h2>
          <p className="font-semibold"
            style={{ fontFamily: "var(--font-montserrat), system-ui, sans-serif", fontSize: "clamp(1.1rem, 2vw, 1.35rem)", color: "#9BCB6C" }}>
        ...
        <div className="flex justify-center">
          <Link href="/diensten" className="inline-flex items-center gap-2"
            style={{ border: "1.5px solid #9BCB6C", color: "#9BCB6C", background: "#FFFFFF", borderRadius: "8px", padding: "0.875rem 1.75rem", fontFamily: "var(--font-montserrat), system-ui, sans-serif", fontWeight: 600, fontSize: "0.9375rem", textDecoration: "none" }}>
